...
-- Change to new love version
--local isdir = love.filesystem.isDirectory
local isdir = function(item) return love.filesystem.getInfo(item).type == "directory" end 
--local lastmodified = love.filesystem.getLastModified
local lastmodified = function(item) return love.filesystem.getInfo(item).modtime end 
